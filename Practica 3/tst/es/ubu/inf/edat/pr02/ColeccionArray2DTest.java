...
public class ColeccionArray2DTest {
	...
	@Test
	public void pruebaColecciónArray2D_Integer() {
	...
	@Test
	public void pruebaColecciónArray2D_Integer_Modificado() {

		pruebaColecciónArray2D_Integer();

		// Cambiamos algón elemento del array
		arrayInteger[0][0] = -1;
		arrayInteger[1][1] = -5;
		arrayInteger[2][2] = -9;
	...
	@Test
	public void pruebaColecciónArray2D_String() {
...
//		colecciónInteger =	new ColecciónArray2D<Integer>(arrayInteger);
//
